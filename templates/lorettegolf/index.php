		...
		<div class="row-fluid">
			<div id="top">
				<div class="span3" id="left">
					<a title="BizVew - Business - Local Business Directory - Winnipeg Manitoba"><img src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/images/logo.gif" class="myLogo" alt="3 Fathoms"></a>
