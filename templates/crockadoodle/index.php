		...
		<div id="pageContent"> 
			<div class="row-fluid">
				<div class="span3" id="left">
					<a title="BizVew - Business - Local Business Directory - Winnipeg Manitoba"><img src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/images/logo.png" class="logo" alt="Crock A Doodle"></a>
